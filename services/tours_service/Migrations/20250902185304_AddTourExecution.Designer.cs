...
namespace tours_service.Migrations
{
    ...
    [Migration("20250902185304_AddTourExecution")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tours_service.src.Tours.Application.Domain.CheckpointProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CheckpointProgresses", "tours");
                });
            ...
            modelBuilder.Entity("tours_service.src.Tours.Application.Domain.TourExecution", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("tours_service.src.Tours.Application.Domain.CheckpointProgress", b =>
                {
                    b.HasOne("tours_service.src.Tours.Application.Domain.Checkpoint", null)
                        .WithMany()
                        .HasForeignKey("CheckpointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("tours_service.src.Tours.Application.Domain.TourExecution", null)
                        .WithMany("CheckpointProgresses")
            ...
            modelBuilder.Entity("tours_service.src.Tours.Application.Domain.TourExecution", b =>
                {
                    b.Navigation("CheckpointProgresses");
                });

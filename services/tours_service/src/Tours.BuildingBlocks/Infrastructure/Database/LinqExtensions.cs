...
namespace tours_service.src.Tours.BuildingBlocks.Infrastructure.Database;
public static class LinqExtensions
{
  /// <summary>
  /// LINQ extension that should be called last to get paged items. Includes ordering by Id.
  /// </summary>
  public static async Task<PagedResult<T>> GetPagedById<T>(this IQueryable<T> source, int pageIndex, int pageSize) where T : BaseEntity
  {
